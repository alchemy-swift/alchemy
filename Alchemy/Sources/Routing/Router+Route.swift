...
public struct Route {
    ...
    public init(method: HTTPRequest.Method, path: String, options: RouteOptions = [], handler: @escaping (Request) async throws -> ResponseConvertible) {
        self.method = method
        self.path = path
    ...
    public init(method: HTTPRequest.Method, path: String, options: RouteOptions = [], handler: @escaping (Request) async throws -> Void) {
        self.method = method
        self.path = path
        self.options = options
        self.handler = { req in
    ...
    public init<E: Encodable>(method: HTTPRequest.Method, path: String, options: RouteOptions = [], handler: @escaping (Request) async throws -> E) {
        self.method = method
        self.path = path
        self.options = options
        self.handler = { req in
