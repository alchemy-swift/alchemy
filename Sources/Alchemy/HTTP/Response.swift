...
public final class Response {
    ...
    /// Creates a new response using a status code, headers, body and optional Content-Type.
    ...
    /// Creates a new response using a status code, headers and `ByteBuffer` for the body..
