...
public class Query: Sequelizable {
    ...
    /// - Returns: The current query builder `Query` to chain future
    ///   queries to.
    public func orWhere(key: String, in values: [QueryParameter], type: WhereIn.InType = .in) -> Self {
        return self.where(
            key: key,
            in: values,
            type: type,
    ...
    /// - Returns: The current query builder `Query` to chain future
    ///   queries to.
    public func whereNot(key: String, in values: [QueryParameter], boolean: WhereBoolean = .and) -> Self {
    ...
    /// - Returns: The current query builder `Query` to chain future
    ///   queries to.
    public func orWhereNot(key: String, in values: [QueryParameter]) -> Self {
    ...
    /// - Returns: The current query builder `Query` to chain future
    ///   queries to.
    public func whereRaw(sql: String, bindings: [QueryParameter], boolean: WhereBoolean = .and) -> Self {
    ...
    /// - Returns: The current query builder `Query` to chain future
    ///   queries to.
    public func orWhereRaw(sql: String, bindings: [QueryParameter]) -> Self {
    ...
    /// - Returns: The current query builder `Query` to chain future
    ///   queries to.
    public func having(key: String, op: Operator, value: QueryParameter, boolean: WhereBoolean = .and) -> Self {
    ...
    public func insert(
        _ value: OrderedDictionary<String, QueryParameter>,
    ...
    /// - Returns: The inserted rows.
    public func insert(
        _ values: [OrderedDictionary<String, QueryParameter>],
        returnItems: Bool = true
    ) async throws -> [DatabaseRow] {
    ...
    ///   updated.
    public func update(values: [String: QueryParameter]) async throws {
...
extension String {
    ...
    public static func == (lhs: String, rhs: QueryParameter) -> WhereValue {
