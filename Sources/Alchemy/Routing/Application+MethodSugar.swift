...
extension Application {
    ...
    /// `GET` wrapper of `Application.on(method:path:handler:)`.
    public func get(_ path: String = "", handler: @escaping VoidFutureHandler) {
        self.on(.GET, at: path, handler: handler)
    }
    
    /// `POST` wrapper of `Application.on(method:path:handler:)`.
    public func post(_ path: String = "", handler: @escaping VoidFutureHandler) {
        self.on(.POST, at: path, handler: handler)
    }
    
    /// `PUT` wrapper of `Application.on(method:path:handler:)`.
    public func put(_ path: String = "", handler: @escaping VoidFutureHandler) {
        self.on(.PUT, at: path, handler: handler)
    }
    
    /// `PATCH` wrapper of `Application.on(method:path:handler:)`.
    public func patch(_ path: String = "", handler: @escaping VoidFutureHandler) {
        self.on(.PATCH, at: path, handler: handler)
    }
    
    /// `DELETE` wrapper of `Application.on(method:path:handler:)`.
    public func delete(_ path: String = "", handler: @escaping VoidFutureHandler) {
        self.on(.DELETE, at: path, handler: handler)
    }
    
    /// `OPTIONS` wrapper of `Application.on(method:path:handler:)`.
    public func options(_ path: String = "", handler: @escaping VoidFutureHandler) {
        self.on(.OPTIONS, at: path, handler: handler)
    }
    
    /// `HEAD` wrapper of `Application.on(method:path:handler:)`.
    public func head(_ path: String = "", handler: @escaping VoidFutureHandler) {
        self.on(.HEAD, at: path, handler: handler)
    }
    ...
    /// `GET` wrapper of `Application.on(method:path:handler:)`.
    public func get<E: Encodable>(_ path: String = "", handler: @escaping EncodableHandler<E>) {
        self.on(.GET, at: path, handler: handler)
    }
    
    /// `POST` wrapper of `Application.on(method:path:handler:)`.
    public func post<E: Encodable>(_ path: String = "", handler: @escaping EncodableHandler<E>) {
        self.on(.POST, at: path, handler: handler)
    }
    
    /// `PUT` wrapper of `Application.on(method:path:handler:)`.
    public func put<E: Encodable>(_ path: String = "", handler: @escaping EncodableHandler<E>) {
        self.on(.PUT, at: path, handler: handler)
    }
    
    /// `PATCH` wrapper of `Application.on(method:path:handler:)`.
    public func patch<E: Encodable>(_ path: String = "", handler: @escaping EncodableHandler<E>) {
        self.on(.PATCH, at: path, handler: handler)
    }
    
    /// `DELETE` wrapper of `Application.on(method:path:handler:)`.
    public func delete<E: Encodable>(_ path: String = "", handler: @escaping EncodableHandler<E>) {
        self.on(.DELETE, at: path, handler: handler)
    }
    
    /// `OPTIONS` wrapper of `Application.on(method:path:handler:)`.
    public func options<E: Encodable>(_ path: String = "", handler: @escaping EncodableHandler<E>) {
        self.on(.OPTIONS, at: path, handler: handler)
    }
    
    /// `HEAD` wrapper of `Application.on(method:path:handler:)`.
    public func head<E: Encodable>(_ path: String = "", handler: @escaping EncodableHandler<E>) {
        self.on(.HEAD, at: path, handler: handler)
    }
    ...
    /// `GET` wrapper of `Application.on(method:path:handler:)`.
    public func get<E: Encodable>(_ path: String = "", handler: @escaping EncodableFutureHandler<E>) {
        self.on(.GET, at: path, handler: handler)
    }
    
    /// `POST` wrapper of `Application.on(method:path:handler:)`.
    public func post<E: Encodable>(_ path: String = "", handler: @escaping EncodableFutureHandler<E>) {
        self.on(.POST, at: path, handler: handler)
    }
    
    /// `PUT` wrapper of `Application.on(method:path:handler:)`.
    public func put<E: Encodable>(_ path: String = "", handler: @escaping EncodableFutureHandler<E>) {
        self.on(.PUT, at: path, handler: handler)
    }
    
    /// `PATCH` wrapper of `Application.on(method:path:handler:)`.
    public func patch<E: Encodable>(_ path: String = "", handler: @escaping EncodableFutureHandler<E>) {
        self.on(.PATCH, at: path, handler: handler)
    }
    
    /// `DELETE` wrapper of `Application.on(method:path:handler:)`.
    public func delete<E: Encodable>(_ path: String = "", handler: @escaping EncodableFutureHandler<E>) {
        self.on(.DELETE, at: path, handler: handler)
    }
    
    /// `OPTIONS` wrapper of `Application.on(method:path:handler:)`.
    public func options<E: Encodable>(_ path: String = "", handler: @escaping EncodableFutureHandler<E>) {
        self.on(.OPTIONS, at: path, handler: handler)
    }
    
    /// `HEAD` wrapper of `Application.on(method:path:handler:)`.
    public func head<E: Encodable>(_ path: String = "", handler: @escaping EncodableFutureHandler<E>) {
        self.on(.HEAD, at: path, handler: handler)
    }
}
