...
extension BCryptDigest {
    ...
    /// - Returns: A future containing the hashed password that will resolve on the initiating
    //             `EventLoop`.
    ...
    /// - Returns: A future containing a `Bool` indicating whether the password and hash matched.
    ///            This will resolve on the initiating `EventLoop`.
