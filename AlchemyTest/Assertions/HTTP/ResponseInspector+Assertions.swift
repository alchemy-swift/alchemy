...
extension ResponseInspector {
    ...
    @discardableResult
    public func assertRedirect(
        to uri: String? = nil, file: StaticString = #filePath, line: UInt = #line
    ) -> Self {
    ...
    public func assertStatus(
        _ status: HTTPResponse.Status, file: StaticString = #filePath, line: UInt = #line
    ) -> Self {
    ...
    @discardableResult
    public func assertStatus(_ code: Int, file: StaticString = #filePath, line: UInt = #line)
        -> Self
    {
