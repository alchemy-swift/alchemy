...
final class ClientResponseTests: XCTestCase {
    ...
    func testBody() {
        ...
        XCTAssertEqual(ClientResponse(response: .with(body: body)).body, Content(buffer: body, contentType: nil))
        XCTAssertEqual(ClientResponse(response: .with(headers: ["content-type": "application/json"], body: body)).body, Content(buffer: body, contentType: .json))
