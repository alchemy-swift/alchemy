...
//    private let dialect = StubDialect()
//    
...
//        XCTAssertEqual(dialect.compileLock(nil), nil)
//        XCTAssertEqual(dialect.compileLock(SQLQuery.Lock(strength: .update, option: nil)), "FOR UPDATE")
//        XCTAssertEqual(dialect.compileLock(SQLQuery.Lock(strength: .share, option: nil)), "FOR SHARE")
//        XCTAssertEqual(dialect.compileLock(SQLQuery.Lock(strength: .update, option: .skipLocked)), "FOR UPDATE SKIP LOCKED")
//        XCTAssertEqual(dialect.compileLock(SQLQuery.Lock(strength: .update, option: .noWait)), "FOR UPDATE NO WAIT")
//    }
//    
