...
//    var id: Int?
//
//    var users: Relationship<[User]> {
//        hasMany()
//            .throughPivot(UserOrganization.self)
//    }
//
//    var usersOver30: Relationship<[User]> {
//        hasMany()
//            .throughPivot(UserOrganization.self)
//            .where("age" >= 30)
//    }
...
//    var managerId: Int?
//
//    var report: Relationship<User?> {
//        hasOne(to: "manager_id")
//    }
//
//    var repositories: Relationship<[Repository]> {
//        hasMany()
//    }
//
//    var jobs: Relationship<[Job]> {
//        hasMany(to: "workflow_id")
//            .through(Repository.self, from: "user_id", to: "id")
//            .through(Workflow.self, from: "repository_id", to: "id")
//    }
//
//    var organizations: Relationship<[Organization]> {
//        hasMany()
//            .throughPivot(UserOrganization.self)
//    }
//}
...
//    }
//
//    var workflows: Relationship<[Workflow]> {
//        hasMany()
//    }
//}
//
...
//
//    var repository: Relationship<Repository> {
//        belongsTo()
//    }
//
//    var jobs: Relationship<[Job]> {
...
//    var workflowId: Int
//
//    var workflow: Relationship<Workflow> {
//        belongsTo()
//    }
//
//    var user: Relationship<User> {
